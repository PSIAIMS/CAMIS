...
We are currently writing a white paper which provides guidance on the types of questions statistical staff should ask to identify the fundamental sources of discrepant results. The objective of this open source repository is to share and receive contributions from the wider community in order to document such discrepancies and explain the rationale for them (Comparing Analysis Method Implementations in Software). This burden of this time consuming task of exploring differences would be vastly reduced by sharing findings with the wider community.

## Conferences presence

-   PSI 2023: 11-14 June 2023. London, England. AIMS SIG Session Tuesday 11:30 "Cross Industry R collaborations and challenges"

-   PHUSE EU Connect 2023: 5-8 November 2023. ICC Birmingham, England
