...
We are a cross-industry PHUSE DVOST Working Group, run in collaboration with members from [PHUSE](https://phuse.global/), [PSI](https://psiaims.github.io/website/), ASA and IASCT. In addition to issue comments, which are hosted in the [GitHub Repository](https://github.com/PSIAIMS/CAMIS/issues), we meet monthly on the 2nd Monday of each month. If you would like to join us please contact us at [workinggroups\@phuse.global](mailto:workinggroups@phuse.global).
