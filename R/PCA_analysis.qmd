...
Principal Component Analysis (PCA) is a dimensionality reduction technique used to reduce the number of features in a dataset while retaining most of the information.The basic idea behind PCA is to transform the original features into a new set of linearly uncorrelated variables called principal components (PCs). These PCs are obtained by finding the directions in the feature space along which the data has the maximum variance.

Steps to Perform PCA in R With Example
