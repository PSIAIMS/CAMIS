...
#We use a weight loss factor while respecting missing values
...
Here if we use the 3 level treatment variable (dose_id), we have 1=10mg, 2=20mg doses 
for active treatment and then 3= placebo which is 0mg. 
