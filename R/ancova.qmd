...
ANOVA is a statistical method used to compare the means of three or more groups to determine if at least one group mean is significantly different from the others. Please see the [anova.qmd](ANOVA page) for more information. ANCOVA is an extension to ANOVA.
