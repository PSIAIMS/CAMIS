...
[gsDesing2](https://merck.github.io/gsDesign2/),
...
and not co-primary endpoints. A GSD will be utilized for each endpoint.
...
O'Brein-Fleming spending function will be used for efficacy testing and
...
In our example, if $X$ is a drop-out time and $X \sim Exponential (\lambda)$,
