...
For the illustration purpose we used $\rho=0,\  \gamma=0$ and in this scenario weighted log-rank test becomes standard log-rank test. Therefore, the result obtained in this illustration is consistent with the result obtained in [standard log-rank test](Survival Analysis Using R (psiaims.github.io)).
