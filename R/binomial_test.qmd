...
The output has a p-value `r binom_test$p.value` $< 0.05$ (chosen level of significance). Hence, we reject the null hypothesis and conclude that **the proportion of death is significantly different from 19%**.
