...
Run all SAS scenario programs from the repository root:

```{sas}
%include "scenario_data/generate_all_scenarios.sas";
```

By default, the SAS programs import the R-generated CSV files. This gives row-level consistency across R and SAS analyses.
