...
Additionally, we present comparative results between SAS `PROC SEQDESIGN` and rpact to provide a comprehensive evaluation framework.
...
knitr::include_graphics(
  "../images/gsd-tte/result-pfs-sas-comp.png"
)
```
...
pfs_sas <- tibble::tribble(
  ...
  'Events: 235', 'HR at bound',        0.74271570535451,   NA_real_,
...
pfs_sas_sum |>
  ...
  dplyr::mutate(
    diff_eff_sas = abs(eff_east - sas_eff),
    diff_fut_sas = abs(fut_east - sas_fut)
  ) |>
  dplyr::select(
    Analysis = analysis,
    Value = value,
