...
From the arguments of `coxph` in R, there are three possible choices for handling tied event times 'ties=breslow', 'ties=efron', or 'ties='clogit'. This last option is an exact partial likelihood approach. See [here](coxph function - RDocumentation) for more detail.
