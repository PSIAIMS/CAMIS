...
I am using the following data to show the differences between the default percentile definitions used by SAS and R:
...
knitr::include_graphics("../images/percentiles/sas-percentiles-output.jpg")
```
...
More information about quantile derivation can be found in [SAS blog](https://blogs.sas.com/content/iml/2021/07/26/compare-quantiles-sas-r-python.html).
