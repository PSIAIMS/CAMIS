...
```{r, echo=FALSE, fig.align='center', out.width="75%"}
knitr::include_graphics("../images/samplesize/StatXact_3.PNG")
```
...
```{r, echo=FALSE, fig.align='center', out.width="75%"}
knitr::include_graphics("../images/samplesize/StatXact_1.PNG")
```
...
```{r, echo=FALSE, fig.align='center', out.width="75%"}
knitr::include_graphics("../images/samplesize/StatXact_5.PNG")
```
...
```{r, echo=FALSE, fig.align='center', out.width="75%"}
knitr::include_graphics("../images/samplesize/StatXact_4.PNG")
```
...
```{r, echo=FALSE, fig.align='center', out.width="75%"}
knitr::include_graphics("../images/samplesize/StatXact_6.PNG")
```
...
```{r, echo=FALSE, fig.align='center', out.width="75%"}
knitr::include_graphics("../images/samplesize/StatXact_7.PNG")
```
