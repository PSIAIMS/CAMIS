...
```{r, echo=FALSE, fig.align='center', out.width="50%"} knitr::include_graphics("../images/count_data_regression/negbin1.png") knitr::include_graphics("../images/count_data_regression/negbin2.png")}
```
