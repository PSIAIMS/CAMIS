...
In example 1, we look at an equality test, when the true difference between treatment groups is assumed to be equal to 0, then SAS assumes you are doing a 2-sided test, $H0:|\mu2-\mu1|\geq \theta$ versus $H1: |\mu2-\mu1|\lt \theta$.
