...
widget_01 <- sasquatch::sas_run_string(capture = "listing", "
data XXX;
    input my_number;
    datalines;
    2.2
...
widget_02 <- sasquatch::sas_run_string(capture = "listing", "
...
widget_03 <- sasquatch::sas_run_string(capture = "listing", "
data dum1;
    int1=0; output;
    do i=1 to 25;
      int1=2**i; output;
...
widget_04 <- sasquatch::sas_run_string(capture = "listing", "
