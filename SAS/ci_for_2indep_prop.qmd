...
## The MOVER methods (Method Of Variance Estimates Recovery, also known as the Newcombe Hybrid Score method, or Square-and-Add)

The original version (denoted MOVER-W) derives the confidence intervals for the separate proportions in each group, $p_1$ and $p_2$, using the Wilson Score Method equations as described [here](ci_for_prop.html). Any other base method may also be selected, for example Jeffreys equal-tailed intervals achieve improved symmetrical coverage, but this MOVER-J variant is not available in SAS.
...
#| fig-align: center 
#| out-width: 75% 
knitr::include_graphics("../images/ci_for_prop/binomial_2sampleRDCI_noCC.png")
```
...
#| fig-align: center 
#| out-width: 50% 
knitr::include_graphics("../images/ci_for_prop/binomial_2sampleRDCI_Mee.png")
```
...
#| fig-align: center 
#| out-width: 50% 
knitr::include_graphics("../images/ci_for_prop/binomial_2sampleRDCI_CC.png")
```
...
#| fig-align: center 
#| out-width: 50% 
knitr::include_graphics("../images/ci_for_prop/binomial_2sampleRDCI_ExactSS.png")
```
...
#| fig-align: center 
#| out-width: 50% 
knitr::include_graphics("../images/ci_for_prop/binomial_2sampleRDCI_ExactAM.png")
```
...
#| fig-align: center 
#| out-width: 75% 
knitr::include_graphics("../images/ci_for_prop/binomial_2sampleRDNonInf.png")
```
...
#| fig-align: center 
#| out-width: 50% 
knitr::include_graphics("../images/ci_for_prop/binomial_2sampleRRCI.png")
knitr::include_graphics("../images/ci_for_prop/binomial_2sampleRRCI_Koopman.png")
```
...
#| fig-align: center 
#| out-width: 50% 
knitr::include_graphics("../images/ci_for_prop/binomial_2sampleRRCI_ExactCZ.png")
```
...
#| fig-align: center 
#| out-width: 50% 
knitr::include_graphics("../images/ci_for_prop/binomial_2sampleRRCI_ExactSS.png")
```
...
#| fig-align: center 
#| out-width: 50% 
knitr::include_graphics("../images/ci_for_prop/binomial_2sampleRRCI_ExactAM.png")
```
...
#| fig-align: center 
#| out-width: 50% 
knitr::include_graphics("../images/ci_for_prop/binomial_2sampleORCI.png")
knitr::include_graphics("../images/ci_for_prop/binomial_2sampleORCI_ScoreN.png")
```
...
#| fig-align: center 
#| out-width: 50% 
knitr::include_graphics("../images/ci_for_prop/binomial_2sampleORCI_Exact.png")
```
