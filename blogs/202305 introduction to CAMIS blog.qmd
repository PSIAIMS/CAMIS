...
library(tibble)
knitr::include_graphics("CAMIS logo - final 2023.png") 
knitr::include_graphics("CAMIS QR code to repo.png")   
```
...
Here's a short video introducing you to CAMIS:

{{< video local-20230505 Blog recording.mp4 >}}
