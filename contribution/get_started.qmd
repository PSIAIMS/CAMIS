...
The CAMIS repository utilizes [`renv`](https://rstudio.github.io/renv/articles/renv.html), which is an R package that helps create reproducible environments. Assuming you downloaded [`{r} R.Version()$version.string`](https://www.r-project.org/), which is the version of R associated with this `renv` project, everything should be relatively straightforward.
